...
/// This will be generated by various calls to unwrap() as of Jan 2018. Since msp430 doesn't
/// meaningfully support faulting on illegal instructions, abort() is not implemented in LLVM.
/// Use a naive loop instead.
#[cfg(all(target_arch = "msp430", feature = "loop-on-abort"))]
#[no_mangle]
